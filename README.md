...
One experiment we can try is to take 5 facts and use each one as an individual prefix before a prompt, observing the indirect effect of that fact. Then to test the positional effect of prefixes we can take all 5 facts and use them as one prefix. Observe [fact1](https://github.com/dannyallover/gpt_interp/blob/main/causal_tracing/figures/gpt2-large/prefix_false_facts_positional/01_1_fact_50_examples.png), [fact2](https://github.com/dannyallover/gpt_interp/blob/main/causal_tracing/figures/gpt2-large/prefix_false_facts_positional/02_1_fact_50_examples.png), [fact3](https://github.com/dannyallover/gpt_interp/blob/main/causal_tracing/figures/gpt2-large/prefix_false_facts_positional/03_1_fact_50_examples.png), [fact4](https://github.com/dannyallover/gpt_interp/blob/main/causal_tracing/figures/gpt2-large/prefix_false_facts_positional/04_1_fact_50_examples.png), [fact5](https://github.com/dannyallover/gpt_interp/blob/main/causal_tracing/figures/gpt2-large/prefix_false_facts_positional/05_1_fact_50_examples.png) and then [[fact1; fact2; fact3; fact4; fact5]](https://github.com/dannyallover/gpt_interp/blob/main/causal_tracing/figures/gpt2-large/prefix_false_facts_positional/5_facts_50_examples.png) stacked together. [I believe it is necessary to use the same 25 examples for this experiment, which I can't recall if I did, so need to redo this]
